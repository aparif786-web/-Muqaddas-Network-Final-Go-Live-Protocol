  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (Platform.OS === 'web') {
        ...
        redirectUrl = currentOrigin || process.env.EXPO_PUBLIC_BACKEND_URL || 'https://gyan-login-fix.preview.emergentagent.com';
      } else {
      ...
      if (!redirectUrl || redirectUrl === 'undefined' || redirectUrl === '') {
        redirectUrl = 'https://gyan-login-fix.preview.emergentagent.com';
      }
